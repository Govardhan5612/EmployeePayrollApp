...
const createInnerHtml = () => {
    ...
    <td>
        <img name="${empPayrollData._id}" onclick="remove(this)" alt="delete" src="7.jpeg" width="30px">
        <img name="${empPayrollData._id}" onclick="update(this)" alt="edit" src="8.jpg" width="30px">
    </td>
</tr>
`;
    }
